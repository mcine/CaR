...
## compile and run user code file    
...
#print(globals_)
script_locals.update(globals_) # custom script lobals made available as glocals when running the robot function.
idx = script_object.co_consts.index('start') -1
print(idx)
if(idx>=0): # run start functin if exists.
...
# TODO: adjust resolutoin, maybe even adjust windows size
SCREEN_HEIGHT = 720
SCREEN_WIDTH = 1080
SCREEN_FPS : int = 30
MAP_HEIGHT = 8
MAP_WIDTH = 8
PLAYER_DIRECTION : float = math.radians(90)
PLAYER_SPEED = 0
...
# casting ray with DDA algorithm
oldcollision = (0,0)
raycount = 0;
